...
<div class="card shadow mb-4">                          
            ...
            <div class="col-md-6">
                ...
                <input type="hidden" name="PaymentId" value="{{$paymentEdit->PaymentId}}"/>
                
                        <div class="col-sm-12 mb-3 mb-sm-0">
                                <label class="text-gray-800"><strong>Payment Method</strong></label>
                                <input class="form-control py-4 " name="Type" type="text" placeholder="Method" value="{{$paymentEdit->Type}}" maxlength="45"  />
                        </div> 
