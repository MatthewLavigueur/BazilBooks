                ...
                <main>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                            <div class="col-lg-5"><h2 class="text-center font-weight-light my-4">Bazil Books</h2></div>
                                   ...
                                   <form action="authentication" method="post">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" name="username" type="email" placeholder="Enter email address" />
                                            </div>
                                            <div class="form-group">
