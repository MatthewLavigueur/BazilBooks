...
<div class="card shadow mb-4">                          
            ...
            <div class="col-md-6">
                ...
                <form class="genre" action="genre-insert" method="post">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                
                        <div class="col-sm-12 mb-3 mb-sm-0">
                                <label class="text-gray-800"><strong>Genre</strong></label>
                                <input class="form-control py-4 " name="type" type="text" placeholder="Type" value="{{old('type')}}" maxlength="45"  />
                        </div> 
                        ...
                        <div class="col-sm-12 mb-3 mb-sm-0">              
                                                ...
                                                <input type="submit" class="btn  btn-info btn-block"  value="Add Genre">
                                                </div>
